...
function gaga_lite_scripts() {
    ...
    wp_enqueue_script( 'gaga-lite-bxslider', get_template_directory_uri() . '/js/bxslider/jquery.bxslider.js', array('jquery'), '1.8.2', true );
    wp_enqueue_script( 'gaga-lite_one-pager-jquery-nav', get_template_directory_uri(). '/js/jquery.nav.js',array('jquery') );
    wp_enqueue_script( 'gaga-lite-custom', get_template_directory_uri() . '/js/custom.js', array('jquery', 'gaga-lite-bxslider', 'gaga-lite_one-pager-jquery-nav',));
    wp_enqueue_style( 'gaga-lite-font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css');
    wp_enqueue_script( 'gaga-lite-progress-main', get_template_directory_uri(). '/js/Circular-Percentage-Loader/js/jquery.classyloader.min.js', array('jquery') );
    wp_enqueue_script( 'gaga-lite-waypoint-js', get_template_directory_uri() . '/js/jquery.waypoints.js');
    wp_enqueue_script( 'gaga-lite-wow_js', get_template_directory_uri() . '/js/wow.js');
    wp_enqueue_style( 'gaga-lite-wow_style',get_template_directory_uri().'/js/animate.css');
    wp_enqueue_script( 'gaga-parallax-background',get_template_directory_uri().'/js/parallax.js',array('jquery'));
    wp_enqueue_script( 'gaga-local-scroll',get_template_directory_uri().'/js/jquery.localScroll.min.js',array('jquery'));
    wp_enqueue_script( 'gaga-local-scroll-to',get_template_directory_uri().'/js/jquery.scrollTo.min.js',array('jquery'));
    wp_enqueue_style( 'gaga-lite-flexisel-slider',get_template_directory_uri().'/js/flexisel-master/css/style.css');
    wp_enqueue_script( 'gaga-lite-flexisel-slider',get_template_directory_uri().'/js/flexisel-master/js/jquery.flexisel.js',array('jquery'));
}
