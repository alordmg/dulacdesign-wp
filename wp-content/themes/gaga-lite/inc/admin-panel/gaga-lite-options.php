...
$gaga_lite_enables = array('slider','about','portfolio','service','blog','cta','testimonial','team','client','skill','pricing');
$gaga_lite_menu_titles = array('about','portfolio','service','blog','cta','testimonial','team','client','skill','pricing');
$gaga_lite_section_titles = array('about','portfolio','service','blog','cta','testimonial','team','client','skill','pricing');
$gaga_lite_section_descriptions = array('service','cta','team');
$gaga_lite_section_bgs = array('about','portfolio','service','blog','cta','testimonial','team','client','skill','pricing');
$gaga_lite_section_bgs_images = array('about','portfolio','service','blog','cta','testimonial','team','client','skill');
...
$font_size = gaga_lite_font_size();

$font_lists = gaga_lite_google_font_list();
...
$gaga_lite_controls = array(
   ...
   'gaga-lite-team_button_link' =>array(
    ...
    'gaga-lite-custom_menu_enable'=>array(
        ...
        'args'=>array(
            'label'=>__('Check to enable primery menu','gaga-lite'),
            'section'=>'gaga-lite-header_section',
            'type'=>'checkbox',
            'priority'=>1
        )
...
**/
    ...
    $wp_customize->add_section(
        'our_product_info',
        array(
          'title'           =>  __('Our Products', 'gaga-lite'),
          'priority'        =>  '2',
          'panel' => 'theme_info', )
        );    
        
        /** Custom controls theme info **/
    $wp_customize->add_setting('gaga_lite_gaga_pro_theme',array(
        'default' => '',
        'sanitize_callback' => 'gaga_lite_sanitize_text',
        ));
        
    $our_product = '<a target="_blank" href="'.esc_url('https://accesspressthemes.com/wordpress-themes/gaga-pro/').'">'.__('Gaga Pro Theme','gaga-lite').'</a>';
    
    $wp_customize->add_control( new Theme_Info_Product_Custom_Control( $wp_customize ,'gaga_lite_gaga_pro_theme',array(
        'label' => __( 'Gaga Pro Theme' , 'gaga-lite' ),
    ...
    $our_product = '<a target="_blank" href="'.admin_url().'themes.php?page=gaga-lite-themes">'.__('More Free Themes','gaga-lite').'</a> <br />';

    $wp_customize->add_control( new Theme_Info_Product_Custom_Control( $wp_customize ,'theme_info_more_theme',array(
        'label' => __( 'More Free Themes' , 'gaga-lite' ),
        'section' => 'our_product_info',
        'description' => $our_product
        )));
    ...
    $our_product = '<a target="_blank" href="https://accesspressthemes.com/wordpress-themes/">'.__('AccessPress PRO Themes','gaga-lite').'</a> <br />';

    $wp_customize->add_control( new Theme_Info_Product_Custom_Control( $wp_customize ,'theme_info_pro_theme',array(
        'label' => __( 'AccessPress PRO Themes' , 'gaga-lite' ),
        'section' => 'our_product_info',
        'description' => $our_product
        )));
    ...
    $our_product = '<a target="_blank" href="'.esc_url('https://accesspressthemes.com/plugins/').'">'.__('AccessPress Plugins','gaga-lite').'</a>';  

    $wp_customize->add_control( new Theme_Info_Product_Custom_Control( $wp_customize ,'theme_info_useful_plugins',array(
        'label' => __( 'AccessPress Plugins' , 'gaga-lite' ),
        'section' => 'our_product_info',
        'description' => $our_product
        )));  
    ...
    $wp_customize->add_section(
        'gaga_pro_features',
        array(
          'title'           =>  __('Gaga Pro Features', 'gaga-lite'),
          'priority'        =>  '4',
          'panel' => 'theme_info', )
    );
